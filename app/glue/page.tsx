      ...
      <div className="max-w-[680px] mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#888] leading-[1.6] mb-6 text-[1em]">
            For claude designers, engineers, and code maximalists who spend a lot
            of time in Figma
          </p>
            ...
            <>
              ...
              <div className="flex flex-col items-center gap-4 max-w-[400px] mx-auto">
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-2.5 w-full px-6 py-3 rounded-lg text-[0.95em] font-[var(--font-lora)] whitespace-nowrap transition-colors ${
                    isValid
